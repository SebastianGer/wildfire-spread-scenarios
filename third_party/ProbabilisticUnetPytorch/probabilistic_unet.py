...
class Encoder(nn.Module):
    ...
    def __init__(
        ...
        # CHANGED to use orthogonal and truncated normal initialization, following Appendix H1
...
class AxisAlignedConvGaussian(nn.Module):
    ...
    def forward(self, input, segm=None):
        ...
        dist = Independent(
            Normal(loc=mu, scale=torch.exp(log_sigma) + self.probability_eps), 1
        )
        return dist
...
class Fcomb(nn.Module):
    ...
    def tile(self, a, dim, n_tile):
        ...
        # CHANGED: Device set to a.device instead of the global device variable
...
class ProbabilisticUnet(nn.Module):
    ...
    # CHANGED: Added probability_eps argument
    def __init__(
        self,
        input_channels=1,
        num_classes=1,
        ...
        # CHANGED: Not setting device here.
        self.unet = Unet(
            self.input_channels,
            self.num_classes,
            self.num_filters,
        ...
        self.prior = AxisAlignedConvGaussian(
            ...
            self.latent_dim,
            self.initializers,
            probability_eps=self.probability_eps,
        )  # .to(device)
    ...
    def elbo(self, segm, analytic_kl=True, reconstruct_posterior_mean=False):
        ...
        # CHANGED: Updated arguments according to torch UserWarning
        ...
        self.reconstruction_loss = (
            torch.sum(reconstruction_loss) / segm.shape[0]
        )  # CHANGED: Added divison by batch size, to match original reimplementation
